...
// function Utilisateur({username, email, telephone}) {
function Utilisateur(props) {
  // const username = props.username;
  const {username, email, telephone} = props;
  return (
    <div className="card" style={{width: "18rem"}}>
      ...
      <div className="card-body">
        ...
        <a href={`tel:+33${telephone}`} className="btn btn-primary">Me contacter au {telephone}</a>
      </div>
    </div>
  );
}
